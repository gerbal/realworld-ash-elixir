defmodule Realworld.Resources.User.Changes.CreateEmailConfirmationToken do
  ...
  def change(changeset, _opts, _context) do
    Ash.Changeset.after_action(changeset, fn changeset, user ->
      ...
      |> Realworld.create(return_notifications?: true)
      |> case do
        {:ok, email_token, notifications} ->
          # notification = Ash.Notifier.Notification.new(Realworld.Resources.User, )
