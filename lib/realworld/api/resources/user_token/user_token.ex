defmodule Realworld.Api.Resources.UserToken do
  use Ash.Resource,
    data_layer: AshPostgres.DataLayer,
    notifiers: [Realworld.Api.Resources.EmailNotifier]

  alias Realworld.Api.Resources.UserToken.Changes, warn: false
  alias Realworld.Api.Resources.Preparations, warn: false
  ...
  relationships do
    belongs_to :user, Realworld.Api.Resources.User
  end
end
